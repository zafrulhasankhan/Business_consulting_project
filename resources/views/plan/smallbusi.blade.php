...
<?php
	   ...
	   <div class="inner">
		...
		<form method="post" action="{{route('profile-complete')}}" enctype="multipart/form-data">
				@csrf
				<textarea name="intro_owner" class="input" id="" cols="30" rows="10" placeholder="Intrduction to owner" required></textarea>
				...
				<textarea name="smallBusiness_plan" class="input" id="" cols="30" rows="10" placeholder="Business work,sell and offer info." required></textarea>  
				...
				<input type="text" class="input" name="staff" placeholder="Number of Staff">
	...
	@else
        ...
        <section>
          <div class="card">
              This is the Small business content page . now you can work as Small business plan.
          </div>
